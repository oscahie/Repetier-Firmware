...
*/
  ...
  UI_PAGE4(ui_page1,"  "cTEMP":%ec/%Ec"cDEG"C","Bed:%eB/%Eb"cDEG"C","Z:%x2 mm","%os");
...
#define UI_MENU_POSITIONS {UI_MENU_ADDCONDBACK &ui_menu_home_all,&ui_menu_home_x,&ui_menu_home_y,&ui_menu_home_z UI_SPEED_X UI_SPEED_Y UI_SPEED_Z}
UI_MENU(ui_menu_positions,UI_MENU_POSITIONS,4 + 3 * UI_SPEED + UI_MENU_BACKCNT);
...
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply,&ui_menu_toggle_light,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_quick_cooldown,&ui_menu_quick_stopstepper DEBUG_PRINT_EXTRA}
UI_MENU(ui_menu_quick,UI_MENU_QUICK,UI_MENU_BACKCNT+BABY_CNT+DEBUG_PRINT_COUNT+8);
...
#elif UI_ROWS>=4
 #if HAVE_HEATED_BED==true
   UI_PAGE4(ui_page1,cTEMP "%ec/%Ec"cDEG "Mul:%om","B%eB/%Eb"cDEG "Flo:%of","Z:%x2 Buf:%oB","%os");
